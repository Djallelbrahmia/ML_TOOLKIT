import numpy as np
from Models.none_linear_models import NoneLinearClassifier
...
model = NoneLinearClassifier(complexity=5, cost_function=cost_function,activation_function="sigmoid")

# Set the seed for reproducibility
seed = 4

# Fit the model
model.fit(X, y, num_epochs=34, batch_size=32, seed=seed, optimizer="adam")
